...
from apps.accounts.constants import AccountsMessages
from apps.accounts.models import User as MyUser
from apps.accounts.tests.test_simplejwt import LOGIN_URL

User = get_user_model()

DEACTIVATE_URL = reverse_lazy("accounts:deactivate_account")
