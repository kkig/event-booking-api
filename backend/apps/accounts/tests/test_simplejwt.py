...
from apps.accounts.constants import PASSWORD_RESET_MESSAGE, PASSWORD_RESET_SUBJECT
from apps.accounts.models import User as MyUser
from apps.common.choices import UserRole

User = get_user_model()

LOGIN_URL = reverse_lazy("accounts:token_obtain_pair")
REFRESH_TOKEN_URL = reverse_lazy("accounts:token_refresh")
USER_PROFILE_URL = reverse_lazy("accounts:user_profile")
CHANGE_PASSWORD_URL = reverse_lazy("accounts:change_password")
PASSWORD_RESET_REQUEST_URL = reverse_lazy("accounts:password_reset_request")
